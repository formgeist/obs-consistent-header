...
exports.getTooltipPositionSelector = re_reselect_1.default([
    ...
    return crosshair_utils_1.getTooltipPosition(chartDimensions, settings.rotation, cursorBandPosition, projectedPointerPosition, scales.xScale.isSingleValue());
