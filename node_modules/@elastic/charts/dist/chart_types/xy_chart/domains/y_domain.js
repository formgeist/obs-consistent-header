...
function mergeYDomainForGroup(dataSeries, groupId, groupSpecs, customDomain) {
    ...
    if (isPercentageStack) {
        domain = domain_1.computeContinuousDataDomain([0, 1], commons_1.identity, (_a = customDomain) === null || _a === void 0 ? void 0 : _a.fit);
    }
    else {
        ...
        var stackedDomain = computeYStackedDomain(stackedDataSeries, isStackedScaleToExtent, (_b = customDomain) === null || _b === void 0 ? void 0 : _b.fit);
        ...
        var nonStackedDomain = computeYNonStackedDomain(nonStackedDataSeries, isNonStackedScaleToExtent, (_c = customDomain) === null || _c === void 0 ? void 0 : _c.fit);
        // merge stacked and non stacked domain together
        domain = domain_1.computeContinuousDataDomain(__spread(stackedDomain, nonStackedDomain), commons_1.identity, isStackedScaleToExtent || isNonStackedScaleToExtent, (_d = customDomain) === null || _d === void 0 ? void 0 : _d.fit);
        var _e = __read(domain, 2), computedDomainMin = _e[0], computedDomainMax = _e[1];
...
function computeYStackedDomain(dataseries, scaleToExtent, fitToExtent) {
    var e_1, _a;
    ...
    return domain_1.computeContinuousDataDomain(dataValues, commons_1.identity, scaleToExtent, fitToExtent);
}
function computeYNonStackedDomain(dataseries, scaleToExtent, fitToExtent) {
    if (fitToExtent === void 0) { fitToExtent = false; }
    var yValues = new Set();
    ...
    return domain_1.computeContinuousDataDomain(__spread(yValues.values()), commons_1.identity, scaleToExtent, fitToExtent);
}
