 ...
 */
exports.getXYValues = function (_a) {
...
exports.getValue = function (current, currentIndex, previous, next, type, endValue) {
    if (previous !== null && type === specs_1.Fit.Carry) {
    ...
    else if (next !== null && type === specs_1.Fit.Lookahead) {
        return __assign(__assign({}, current), { filled: {
                y1: next.y1,
            } });
    }
        ...
        if (type === specs_1.Fit.Average) {
            ...
            var _a = __read(exports.getXYValues(previous), 2), x1 = _a[0], y1 = _a[1];
            var _b = __read(exports.getXYValues(next), 2), x2 = _b[0], y2 = _b[1];
            ...
            else if (type === specs_1.Fit.Linear) {
                return __assign(__assign({}, current), { filled: {
...
exports.fitFunction = function (dataSeries, fitConfig, xScaleType, sorted) {
    ...
    var sortedData = sorted || xScaleType === scales_1.ScaleType.Ordinal ? data : data.slice().sort(stacked_series_utils_1.datumXSortPredicate(xScaleType));
    var newData = [];
