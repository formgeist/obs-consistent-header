...
exports.AGGREGATE_KEY = 'value'; // todo later switch back to 'aggregate'
...
function groupByRollup(keyAccessors, valueAccessor, _a, factTable) {
    ...
    var reductionMap = factTable.reduce(function (p, n, index) {
        ...
        keyAccessors.forEach(function (keyAccessor, i) {
            ...
            pointer.set(key, __assign((_a = {}, _a[exports.AGGREGATE_KEY] = reductionValue, _a[exports.DEPTH_KEY] = i, _a), (!last && (_b = {}, _b[exports.CHILDREN_KEY] = childrenMap, _b))));
            if (childrenMap) {
...
function getRootArrayNode() {
    var _a, _b;
    var children = [];
    var bootstrap = (_a = {}, _a[exports.AGGREGATE_KEY] = NaN, _a[exports.DEPTH_KEY] = NaN, _a[exports.CHILDREN_KEY] = children, _a);
