...
function circlineValidSectors(refC, c) {
    ...
    var a2 = a1p === a2p ? math_1.TAU : Math.max(a1p, a2p); // make a2 drop out in next step
    ...
    for (var i = 0; i < breakpoints.length - 1; i++) {
        ...
        var midAngle = (from_1 + to_1) / 2; // no winding clip ie. `meanAngle()` would be wrong here
...
function conjunctiveConstraint(constraints, c) {
    ...
    for (var i = 0; i < constraints.length; i++) {
        var refC = constraints[i]; // reference circle
        var nextValids = [];
