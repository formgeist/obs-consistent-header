...
function render(partitionSpec, parentDimensions) {
    ...
    return viewmodel_1.shapeViewModel(measure_1.measureText(textMeasurerCtx), config, layers, facts, rawTextGetter(layers), partitionSpec.valueAccessor, partitionSpec.valueFormatter, __spread([function () { return null; }], layers.map(function (_a) {
