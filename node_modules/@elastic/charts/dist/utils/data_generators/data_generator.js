...
var DataGenerator = /** @class */ (function () {
    function DataGenerator(frequency, randomNumberGenerator) {
        ...
        this.generator = new simple_noise_1.Simple1DNoise(randomNumberGenerator);
    ...
    DataGenerator.prototype.generateBasicSeries = function (totalPoints, offset, amplitude) {
        ...
        var dataPoints = new Array(totalPoints).fill(0).map(function (_, i) {
            return {
                x: i,
    ...
    DataGenerator.prototype.generateGroupedSeries = function (totalPoints, totalGroups, groupPrefix) {
        ...
        var groups = new Array(totalGroups).fill(0).map(function (group, i) {
            // eslint-disable-line
            return _this.generateSimpleSeries(totalPoints, i, groupPrefix);
        });
